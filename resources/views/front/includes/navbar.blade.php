    ...
    <header id="rs-header" class="rs-header">
                                                ...
                                                <ul class="cart-icon-product-list">
                                                    <li class="display-flex">
                                                        ...
                                                        <div class="product-image">
                                                            <a href="cart.html"><img src="{{asset('assets/front/images/shop/1.jpg')}}" alt="Product Image"></a>
                                                        </div>
                                                    </li>
                                                    <li class="display-flex">
                                                        <div class="icon-cart">
                                                        ...
                                                        <div class="product-image">
                                                            <a href="cart.html"><img src="{{asset('assets/front/images/shop/2.jpg')}}" alt="Product Image"></a>
                                                        </div>
                                                    </li>
                                                </ul>
        ...
        <nav class="right_menu_togle hidden-md">
            ...
            <div class="canvas-logo">
                <a href="index.html"><img src="{{asset('assets/front/images/dark-logo.png')}}" alt="logo"></a>
            </div>
            ...
            <div class="offcanvas-gallery">
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/1.jpg')}}"><img src="{{asset('assets/front/images/gallery/1.jpg')}}" alt=""></a>
                </div>
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/2.jpg')}}'"><img src="{{asset('assets/front/images/gallery/2.jpg')}}" alt=""></a>
                </div>
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/3.jpg')}}'"><img src="{{asset('assets/front/images/gallery/3.jpg')}}" alt=""></a>
                </div>
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/4.jpg')}}'"><img src="{{asset('assets/front/images/gallery/4.jpg')}}" alt=""></a>
                </div>
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/5.jpg')}}'"><img src="{{asset('assets/front/images/gallery/5.jpg')}}" alt=""></a>
                </div>
                <div class="gallery-img">
                    <a class="image-popup" href="{{asset('assets/front/images/gallery/6.jpg')}}'"><img src="{{asset('assets/front/images/gallery/6.jpg')}}" alt=""></a>
                </div>
            </div>
            <div class="map-img">
                <img src="{{asset('assets/front/images/map.jpg')}}" alt="">
            </div>
