    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title"><span class="text-capitalize">{{$subject->name}}</span> Questions List</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard.home')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('dashboard.subjects.index')}}">Topics</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h5 class="card-title mb-0 ">All <span class="text-capitalize">{{$subject->name}}</span> Questions</h5>
                            </div>
                            <div class="col-4">
