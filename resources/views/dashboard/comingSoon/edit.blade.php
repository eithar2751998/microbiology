    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Edit ComingSoon</h4>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Edit ComingSoon</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('dashboard.coming.update',[$comingSoon->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
